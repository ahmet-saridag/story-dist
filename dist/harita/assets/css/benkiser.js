...
$(document).ready(function () {
    ...
    $('.share-buttons a.twitter-color').click(function (e) {
        e.preventDefault();
        ShareOnTwitter("Söz verdim! Artık " + saving_score + " lt daha az su tüketiyorum. #yarınınsuyu https://yarininsuyu.com/?share=social&score=" + saving_score + '&v=1.1');
    });
    ...
    $('.share-buttons a.instagram-color').click(function (e) {
        e.preventDefault();
        window.open('https://www.yarininsuyu.com/umbraco/surface/ajax/index?type=instagram&score=' + saving_score + '&v=1.1');
    });
        ...
        economicResearchMapsShow.addEventListener("click", function () {
            if (economicResearchMapsItemNumb == economicResearchMapsItem.length || economicResearchMapsItemNumb > 24) {
                ...
                if ($(".map-first-touch").length > 0) {
                    ...
                    economicResearchMapsItemNumb += 4;
                }
...
function shareOnFacebook(score) {
    ...
    var url = 'https://www.yarininsuyu.com/?op=share&share=social&score=' + score + '&v=1.1';
